...
public class FormMemoriaRAM extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FormMemoriaRAM.class.getName());

    private BDEstoque bd = BDEstoque.geraBDEstoque();

    private static FormMemoriaRAM formMemoriaRamUnic;

    private FormMemoriaRAM() {
        initComponents();
    }

    //MÉTODO SINGLETON
    public static FormMemoriaRAM geraFormMemoriaRAM() {
        if (formMemoriaRamUnic == null) {
            formMemoriaRamUnic = new FormMemoriaRAM();
        }
        return formMemoriaRamUnic;
    }
    ...
    private void initComponents() {
        ...
        rotCapac = new javax.swing.JLabel();
        rotTec = new javax.swing.JLabel();
        ...
        cxCapac = new javax.swing.JTextField();
        cxTec = new javax.swing.JTextField();
        ...
        rotFormProc.setText("GERENCIAMENTO MEMÓRIA RAM");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(cxTec, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addComponent(cxCapac, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(65, 65, 65)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cxNome, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(rotCapac)
                            .addComponent(cxCapac, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(22, 22, 22)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cxTec, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(16, 16, 16)
                .addComponent(btMaisInfo)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public void insere() {
        ...
        try {
            ...
            ram.setNome(cxNome.getText());
            ram.setPreco(Double.parseDouble(cxPreco.getText()));
            ram.setQtdEstoque(Integer.parseInt(cxQtd.getText()));

            ram.getFabricante().setMarca(cxMarca.getText()); //REFLEXIVIDADE
            ram.getFabricante().setCnpj(cxCnpj.getText()); //REFLEXIVIDADE

            ram.setTecMemoria(cxTec.getText());
            ram.setCapacidade(Integer.parseInt(cxCapac.getText()));

            bd.inserir(ram);

            JOptionPane.showMessageDialog(this, (ram.getTipoComponente()) + "cadastrado com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
            limpar();
            int resposta = JOptionPane.showConfirmDialog(this,
                    "Deseja aplicar um desconto promocional de 4% neste produto?",
                    "Promoção",
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                try {
                    ram.aplicarDesconto();
                    bd.alterar(ram.getId(), ram);

                    JOptionPane.showMessageDialog(this, "Desconto aplicado com sucesso! Novo preço: R$ " + ram.getPreco());
                    atualizarTabResumo();
    ...
    public void del() {
        try {
            ...
            if (!(h instanceof MemoriaRam)) {
                JOptionPane.showMessageDialog(this, "Atenção: O ID digitado pertence a outro tipo de peça (" + h.getTipoComponente() + "), não a uma Memória RAM.", "Tipo Incompatível", JOptionPane.WARNING_MESSAGE);
                return;
            }
        ...
        try {
            ...
            if (h != null) {
                ...
                if (h instanceof MemoriaRam) {
                    ...
                    cxCapac.setText(String.valueOf(p.getCapacidade()));
                    cxTec.setText(String.valueOf(p.getTecMemoria()));
    ...
    public void modificar() {
        try {
            String entraId = JOptionPane.showInputDialog(this, "Digite o ID da Memória RAM que deseja alterar:", "Modificar", JOptionPane.QUESTION_MESSAGE);
            ...
            if (pecaExistente != null && pecaExistente instanceof MemoriaRam) {

                MemoriaRam ramAtualizada = (MemoriaRam) pecaExistente;
                ...
                if (novoNome != null && !novoNome.trim().isEmpty()) {
                    ramAtualizada.setNome(novoNome);
                }
                ...
                if (novoPreco != null && !novoPreco.trim().isEmpty()) {
                    ramAtualizada.setPreco(Double.parseDouble(novoPreco.replace(",", ".")));
                }
                ...
                if (novaQtd != null && !novaQtd.trim().isEmpty()) {
                    ramAtualizada.setQtdEstoque(Integer.parseInt(novaQtd));
                }
                ...
                if (novaMarca != null && !novaMarca.trim().isEmpty()) {
                    ramAtualizada.getFabricante().setMarca(novaMarca); //REFLEXIVIDADE
                }
                ...
                if (novoCnpj != null && !novoCnpj.trim().isEmpty()) {
                    ramAtualizada.getFabricante().setCnpj(novoCnpj); //REFLEXIVIDADE
                }

                String cap = JOptionPane.showInputDialog(this, "Informe a nova CAPACIDADE (GB):", "Atualizar", JOptionPane.INFORMATION_MESSAGE);
                if (cap != null && !cap.trim().isEmpty()) {
                    ramAtualizada.setCapacidade(Integer.parseInt(cap));
                }

                String tec = JOptionPane.showInputDialog(this, "Informe a nova TECNOLOGIA (ex: DDR4):", "Atualizar", JOptionPane.INFORMATION_MESSAGE);
                if (tec != null && !tec.trim().isEmpty()) {
                    ramAtualizada.setTecMemoria(tec);
                }

                bd.alterar(idBusca, ramAtualizada);

                JOptionPane.showMessageDialog(this, "Memória RAM atualizada com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
                atualizarTabResumo();

            } else {
                JOptionPane.showMessageDialog(this, "Memória RAM não encontrada com o ID: " + idBusca, "Erro", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void cxTecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cxTecActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cxTecActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FormMemoriaRAM().setVisible(true));
    }
    ...
    private javax.swing.JTextField cxCapac;
    ...
    private javax.swing.JTextField cxTec;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JLabel rotCapac;
    ...
    private javax.swing.JLabel rotTec;
