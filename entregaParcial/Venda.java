...
public class Venda {
    ...
    private List<Hardware> carrinho;
    ...
    // ==========================================
    // REGRA DE NEGÓCIO: ADICIONAR AO CARRINHO
    // ==========================================
    public void adicionarItem(Hardware item) {
        this.carrinho.add(item);

        // Como o seu metodo setPreco() lá no cadastro já calculou e
        // salvou o valor com o desconto polimórfico, aqui nós apenas somamos!
